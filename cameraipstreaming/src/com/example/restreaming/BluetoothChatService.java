...
public class BluetoothChatService {
	...
	public int demtrai=0;
	public int demphai=0;
	public static  int vitrihientai=0;
	// Debugging
	...
	private synchronized void setState(int state) {
		...
		mHandler.obtainMessage(SettingsActivity.MESSAGE_STATE_CHANGE, state, -1)
				.sendToTarget();
	}
	...
	private class ConnectedThread extends Thread {
		...
		public void run() {
			...
			while (true) {
				try {
					...
					mHandler.obtainMessage(SettingsActivity.MESSAGE_READ,
		...
		public void write(byte[] buffer) {
			try {
				...
				mHandler.obtainMessage(SettingsActivity.MESSAGE_WRITE, -1, -1,
						buffer).sendToTarget();
			} catch (IOException e) {
    ...
    public void quay(int i)
    {
       if(i==2)  //quay sang phai
       {
    	   System.out.println("gui lenh quay phai\n");
    	   switch(vitrihientai)
    	   {
    	   case 1:
    		    Arrays.fill(mBuffer, (byte)0x32);
				vitrihientai=2;
				break;
    	   case 2:
   		    Arrays.fill(mBuffer, (byte)0x33);
				vitrihientai=3;
				break;
    	   case 3:
   		    Arrays.fill(mBuffer, (byte)0x34);
				vitrihientai=4;
				break;
    	   case 4:
   		        Arrays.fill(mBuffer, (byte)0x35);
				vitrihientai=5;
				break;
    	   case 5:
   		    Arrays.fill(mBuffer, (byte)0x35);
       ...
       if(i==1)
       {
    	   System.out.println("gui lenh quay trai\n");
    	   switch(vitrihientai)
    	   {
    	   case 1:
   		    Arrays.fill(mBuffer, (byte)0x31);
				vitrihientai=1;
				break;
    	   case 2:
   		    Arrays.fill(mBuffer, (byte)0x31);
