...
void 
Java_com_example_restreaming_StreamingHeadlessCamcorder_pixeltobmp( JNIEnv* env,jobject thiz,jobject bitmap){
...
jint 
Java_com_example_restreaming_StreamingHeadlessCamcorder_prepareCamera( JNIEnv* env,jobject thiz, jint videoid){
...
jint 
Java_com_example_restreaming_StreamingHeadlessCamcorder_prepareCameraWithBase( JNIEnv* env,jobject thiz, jint videoid, jint videobase){
	
		int ret;

		camerabase = videobase;
	
		return Java_com_example_restreaming_StreamingHeadlessCamcorder_prepareCamera(env,thiz,videoid);
	
}

void 
Java_com_example_restreaming_StreamingHeadlessCamcorder_processCamera( JNIEnv* env,
										jobject thiz){
...
void 
Java_com_example_restreaming_StreamingHeadlessCamcorder_stopCamera(JNIEnv* env,jobject thiz){
