...
JNIEXPORT jint JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeOpenFromRawStream(JNIEnv* env, jobject thiz, jbyteArray mediaframe);
...
JNIEXPORT void JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeClose(JNIEnv* env, jobject thiz);
...
JNIEXPORT jint JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeOpenAudio(JNIEnv* env, jobject thiz, jbyteArray audioframe, jintArray audioframelength);

JNIEXPORT void JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeCloseAudio(JNIEnv* env, jobject thiz);

JNIEXPORT jint JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeOpenVideo(JNIEnv* env, jobject thiz, jobject bitmap);
...
JNIEXPORT jint JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeDecodeFrameFromRawStream(JNIEnv* env, jobject thiz);

JNIEXPORT jint JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeUpdateBitmap(JNIEnv* env, jobject thiz);
...
JNIEXPORT void JNICALL Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeClose(JNIEnv* env, jobject thiz)
    ...
    Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeCloseAudio(env, thiz);
    Java_com_example_restreaming_StreamingHeadlessCamcorder_nativeCloseVideo(env, thiz);
